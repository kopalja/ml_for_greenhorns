...
class Model:
    ...
    def predict(self, text, dictionary):
        last_word = []
        r = []
        for index, ch in enumerate(text):
            was_cap = ch.lower() != ch
            ...
            if ch == ' ':
                ...
                if last_no_dia in dictionary.variants and last_word not in dictionary.variants[last_no_dia]:
                    r = r[:-len(last_word)]
...
if __name__ == "__main__":
    from diacritization2 import Model, Net, Encoder
